...
export default function Experience() {
  ...
  return (
<div>
    <div className='md:text-5xl font-extrabold pt-20 pl-8 md:pl-45 mb-8'>
        My Experiences
    </div>
    <div id='experience' className="w-full min-h-screen flex items-start justify-center pl-8 md:p-16"> 
          ...
          <li className="mb-10 ms-6">            
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-heading my-2"> <b>MPencil</b>  - Software Quality Analyst <span><i className='text-zinc-500 ml-2'>(Intern)</i></span> <span className="ms-2 bg-brand-softer border border-brand-subtle text-fg-brand-strong text-xs font-medium px-1.5 py-0.5 rounded">Current</span></h3>
                <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li>Performed regression testing to ensure stable releases.</li>
                </ul>              
              <a href="" className="inline-flex pt-2 mt-2 items-center text-body bg-neutral-secondary-medium box-border border border-default-medium hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
          ...
          <li className="mb-10 ms-6">
              ...
              <h3 className="my-2 text-lg font-semibold text-heading">Orange Essence Technology</h3>
                <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li>Integrated a Lexical rich-text editor into the e-commerce platform to enhance dynamic content management.</li>
                    <li>Integrated PhonePe payment gateway for secure and seamless online transactions.</li>
                </ul>
              <a href="https://drive.google.com/file/d/1aujexi5LhFRSTREAYYW0BdBnR3zEZuC3/view" target="_blank" className="inline-flex pt-2 mt-2 items-center text-body bg-neutral-secondary-medium box-border border border-default-medium hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
                  <svg className="w-4 h-4 me-1.5 -ms-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M10 3v4a1 1 0 0 1-1 1H5m14-4v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7.914a1 1 0 0 1 .293-.707l3.914-3.914A1 1 0 0 1 9.914 3H18a1 1 0 0 1 1 1Zm-4 1h.01v.01H15V5Zm-2 2h.01v.01H13V7Zm2 2h.01v.01H15V9Zm-2 2h.01v.01H13V11Zm2 2h.01v.01H15V13Zm-2 2h.01v.01H13V15Zm2 2h.01v.01H15V17Zm-2 2h.01v.01H13V19Z"/></svg>
                  Certificate
              </a>
          </li>
          <li className="ms-6">
              ...
              <h3 className="my-2 text-lg font-semibold text-heading">Weld and Metal Fabrications</h3>
                <ul className="list-disc ml-5 space-y-1">
                    ...
                    <li>Optimized backend APIs and storage handling to ensure smooth production performance.</li>
                </ul>
              <a href="https://drive.google.com/file/d/1MpTR5YEi0og_D6YOhyBOJ_2lIt5fOijC/view" target="_blank" className="inline-flex pt-2 mt-2 items-center text-body bg-neutral-secondary-medium box-border border border-default-medium hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-4 focus:ring-neutral-tertiary shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
                  <svg className="w-4 h-4 me-1.5 -ms-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M10 3v4a1 1 0 0 1-1 1H5m14-4v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V7.914a1 1 0 0 1 .293-.707l3.914-3.914A1 1 0 0 1 9.914 3H18a1 1 0 0 1 1 1Zm-4 1h.01v.01H15V5Zm-2 2h.01v.01H13V7Zm2 2h.01v.01H15V9Zm-2 2h.01v.01H13V11Zm2 2h.01v.01H15V13Zm-2 2h.01v.01H13V15Zm2 2h.01v.01H15V17Zm-2 2h.01v.01H13V19Z"/></svg>
                  Certificate
              </a>
          </li>
